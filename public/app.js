...
const MENU = [
  ...
  { id:'formules-menu-tacos-gourmand', cat:'formules', name:'Menu Tacos Gourmand', desc:'1 burger classique au choix + 1 Tacos L au choix , servi avec 1 frite et boisson au choix.', price:13.90, emoji:'🌮', img:'formules-menu-tacos-gourmand.jpg', custom:{boissonMenu:DRINKS} },
  ...
  { id:'menus-duo-burgers-menu-b7-big-burger-giiant', cat:'menus-duo-burgers', name:'Menu B7 (Big Burger Giant)', desc:'Big burger + Giant servi avec 1 frite et boisson au choix.', price:12.50, emoji:'🍔', img:'menus-duo-burgers-menu-b7-big-burger-giiant.jpg', custom:{boissonMenu:DRINKS} },
  { id:'menus-duo-burgers-menu-b8-2-giiant-bugers', cat:'menus-duo-burgers', name:'Menu B8 (2 Giant Burgers)', desc:'2 Giant burgers servi avec 1 frite et boisson au choix', price:12.50, emoji:'🍔', img:'menus-duo-burgers-menu-b8-2-giiant-bugers.jpg', custom:{boissonMenu:DRINKS} },
  ...
  { id:'burgers-seuls-triple-cheese', cat:'burgers-seuls', name:'Triple Cheese', desc:'Pain simple, 3 steaks, ketchup, moutarde, oignons et cornichons', price:6.00, emoji:'🍔', img:'menus-burgers-menu-triple-cheese.jpg', custom:{menu:2.50} },
  { id:'burgers-seuls-tasty-burger', cat:'burgers-seuls', name:'Tasty Burger', desc:'Pain sésame, 1 steak 90 g, sauce tasty, emmental, salade, oignons rouges et tomate.', price:7.50, emoji:'🍔', img:'menus-burgers-menu-tasty-burger.jpg', custom:{menu:2.40} },
  ...
  { id:'burgers-seuls-double-chesse-burger', cat:'burgers-seuls', name:'Double Cheese Burger', desc:'Pain simple, 2 steaks, 2 cheddar, ketchup, moutarde, oignon et cornichons.', price:4.00, emoji:'🍔', img:'menus-burgers-menu-double-cheese.jpg', custom:{menu:3.50} },
  ...
  { id:'menu-naandwich-menu-naan-fondu', cat:'menu-naandwich', name:'Naan Fondu', desc:'Escalope de poulet, Mozzarella, poulet fumé, crudités et sauce au choix.', price:6.90, emoji:'🌯', img:'menu-naandwich-menu-naan-fondu.jpg', custom:{menu:3.00,pain:PAINS,condiments:COND} },
  ...
  { id:'menu-naandwich-menu-naan-super-trio', cat:'menu-naandwich', name:'Naan Super Trio', desc:'3 steaks, œuf, Boursin, poulet fumé et cheddar, crudités et sauce au choix.', price:6.90, emoji:'🌯', img:'menu-naandwich-menu-naan-super-trio.jpg', custom:{menu:3.00,pain:PAINS,condiments:COND} },
  ...
  { id:'menus-sandwichs-menu-fondu', cat:'menus-sandwichs', name:'Fondu', desc:'Pain au choix, escalope de poulet, poulet fumé et Mozzarella, crudités et sauce au choix.', price:6.50, emoji:'🌯', img:'menus-sandwichs-menu-fondu.jpg', custom:{menu:3.00,pain:PAINS,condiments:COND} },
...
// ═══ TRACKING ═════════════════════════════════════════════════
function openTrack(){$('track-modal').classList.add('open');$('track-overlay').classList.add('open');lockScroll();const saved=JSON.parse(localStorage.getItem('bikersfood_customer')||'{}');if(saved.phone)$('track-phone').value=phonePretty(saved.phone);}
